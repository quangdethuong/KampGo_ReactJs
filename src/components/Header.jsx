            ...
            <header className="header-v3">
                            ...
                            <div className="menu-desktop">
                                <ul className="main-menu">
                                    <li>
                                        ...
                                        <NavLink activeClassName="activeNavItem" activeStyle={{ fontWeight: 'bold' }} className="nav-link animsition-link" to="/home">Home</NavLink>
                                        {/* <a href="/home">Home</a> */}
                                    </li>
                                    <li>
                                        {/* <a href="/shop">Shop</a> */}

                                        <NavLink activeClassName="activeNavItem" activeStyle={{ fontWeight: 'bold' }} className="nav-link" to="/shop">Shop</NavLink>
                                    </li>
                                    <li className="">
                                        <a href="shoping-cart.html" className='active-menu'>Features</a>
                                    </li>
                                    <li>
                ...
                <div className="wrap-header-mobile">
                    <div className="logo-mobile">
                        <a href="index-2.html"><img src={require('../assets/images/icons/Asset-1.png')} alt="IMG-LOGO" /></a>
                    </div>
                    ...
                    <div className="top-bar">
                        <div className="content-topbar flex-sb-m h-full container">
                            ...
                            <div className="right-top-bar flex-w h-full">
                                <a href="a" className="flex-c-m trans-04 p-lr-25"> Help &amp; FAQs </a>
                                <a href="profile.html" className="flex-c-m trans-04 p-lr-25"> My Account </a>
                                <a href="a" className="flex-c-m trans-04 p-lr-25"> EN </a>
                                <a href="a" className="flex-c-m trans-04 p-lr-25"> USD </a>
                            </div>
                        </div>
                    </div>
                    <div className="wrap-menu-desktop">
