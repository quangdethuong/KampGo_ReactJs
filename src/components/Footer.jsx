            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <ul>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Sup Tour </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Camping Products </a>
                            </li>
                    ...
                    <div className="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <ul>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04">
                                    Track Order
                                </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Returns </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04">
                                    Shipping
                            ...
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> FAQs </a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <p className="stext-107 cl7 size-201">
                            Any questions? Let us know in 600,  Nguyễn Văn Cừ (nối dài), phường An Bình, quận Ninh Kiều, TP. Cần Thơ or call us 0944370119(developer)
                        </p>
