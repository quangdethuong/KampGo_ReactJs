            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <ul>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Women </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Men </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Shoes </a>
                            </li>
                            <li className="p-b-10">
                                <a href="a" className="stext-107 cl7 hov-cl1 trans-04"> Watches </a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-sm-6 col-lg-3 p-b-50">
